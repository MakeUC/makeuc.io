            ...
            <div className="grid sm:grid-cols-1">
              <div className="mt-12 text-left text-black">
                ...
                <Card className="m-4 bg-white text-center is-centered is-rounded">
                  ...
                  <br />
                  <p style={{ fontSize: '20px' }}>
                    As we begin to move forward into 2022, MakeUC is proud to announce that we will
                    be open to partial in-person attendance! Information on in-person attendance
